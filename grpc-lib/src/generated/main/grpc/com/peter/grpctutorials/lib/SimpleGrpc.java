package com.peter.grpctutorials.lib;
...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.peter.grpctutorials.lib.HelloRequest,
      com.peter.grpctutorials.lib.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = com.peter.grpctutorials.lib.HelloRequest.class,
      responseType = com.peter.grpctutorials.lib.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.peter.grpctutorials.lib.HelloRequest,
      com.peter.grpctutorials.lib.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.peter.grpctutorials.lib.HelloRequest, com.peter.grpctutorials.lib.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<com.peter.grpctutorials.lib.HelloRequest, com.peter.grpctutorials.lib.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.peter.grpctutorials.lib.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.peter.grpctutorials.lib.HelloReply.getDefaultInstance()))
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.peter.grpctutorials.lib.HelloRequest,
                com.peter.grpctutorials.lib.HelloReply>(
  ...
  public static final class SimpleBlockingStub extends io.grpc.stub.AbstractBlockingStub<SimpleBlockingStub> {
     ...
     * </pre>
     */
    public com.peter.grpctutorials.lib.HelloReply sayHello(com.peter.grpctutorials.lib.HelloRequest request) {
  ...
  public static final class SimpleFutureStub extends io.grpc.stub.AbstractFutureStub<SimpleFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.peter.grpctutorials.lib.HelloReply> sayHello(
        com.peter.grpctutorials.lib.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.peter.grpctutorials.lib.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.peter.grpctutorials.lib.HelloReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.peter.grpctutorials.lib.HelloWorldProto.getDescriptor();
    }
